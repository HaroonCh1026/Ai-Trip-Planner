    ...
    >
      ...
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: `linear-gradient(to bottom, rgba(13,13,13,0.4) 0%, rgba(13,13,13,0.85) 100%)`,
        }}
      />
      ...
      <div
        style={{ position: "absolute", bottom: 40, left: "5%", right: "5%" }}
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div className="section-label">AI-Generated Itinerary</div>
          <h1
            className="display-heading"
            style={{ fontSize: "clamp(28px, 5vw, 56px)", marginBottom: 12 }}
          >
          ...
          <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
            ...
            >
              <Icon.dollar /> PKR {getBudget().toLocaleString()} estimated
            </div>
          </div>
        </div>
      </div>
